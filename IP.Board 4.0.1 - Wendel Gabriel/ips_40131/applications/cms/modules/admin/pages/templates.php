...
class _templates extends \IPS\Dispatcher\Controller
{
	...
	public function addTemplate()
	{
		...
		$form->add( new \IPS\Helpers\Form\Text( 'template_title', NULL, TRUE ) );
		...
		else
		{
			...
			$form->add( new \IPS\Helpers\Form\Text( 'template_group_new', NULL, FALSE, array( 'regex' => '/^([a-z0-9_]+?)?$/' ), NULL, NULL, NULL, 'group_new' ) );
