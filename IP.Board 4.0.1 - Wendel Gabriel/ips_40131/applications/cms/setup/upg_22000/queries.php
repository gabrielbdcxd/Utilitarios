...
$SQL[]	= "UPDATE core_permission_index SET perm_type='categories' WHERE app='ccs' AND perm_type='cat';";
$SQL[]	= "UPDATE core_permission_index SET perm_type='databases' WHERE app='ccs' AND perm_type='database';";