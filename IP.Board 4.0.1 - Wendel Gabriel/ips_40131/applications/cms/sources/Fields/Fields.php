	...
	*/
	...
	public function form( &$form )
	{
		...
		$toggles = array(
			...
			'CheckboxSet' => array_merge( array( 'field_extra', 'field_default_value', 'field_filter', 'field_truncate' ), $displayDefaults ),
	...
	public function buildHelper( $value=NULL, $customValidationCode=NULL, \IPS\cms\Records $record = NULL, $flags=0 )
	{
		...
		switch ( ucfirst( $this->type ) )
		{
			...
			case 'Radio':
				...
				if ( ucfirst( $this->type ) === 'CheckboxSet' and ! is_array( $value ) )
				{
					$value = explode( ',', $value );
				}
