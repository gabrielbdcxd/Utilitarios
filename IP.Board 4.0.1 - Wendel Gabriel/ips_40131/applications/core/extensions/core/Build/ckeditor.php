...
class _Ckeditor
{
	...
	{
		//@copy( \IPS\ROOT_PATH . '/applications/core/dev/ckeditor/plugins/pbckcode/dialogs/ace/ace.js', \IPS\ROOT_PATH . '/applications/core/interface/ckeditor/ckeditor/plugins/pbckcode/dialogs/ace/ace.js' );
	}
}