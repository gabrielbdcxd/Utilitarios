...
class _GroupSettings
{
	...
	public function process( &$form, $group )
	{
		...
		{
			$form->add( new \IPS\Helpers\Form\Custom( 'group_username', array( $group->g_dname_changes, $group->g_displayname_unit, $group->g_bitoptions['gbw_displayname_unit_type'], $group->g_dname_date, 'canchange' => (bool) $group->g_dname_changes ), FALSE, array(
				'getHtml' => function( $element )
				{
		...
		if( $group->g_id != \IPS\Settings::i()->guest_group )
		{
			...
			$form->add( new \IPS\Helpers\Form\Number( 'g_sig_max_images', $signatureLimits[1], FALSE, array( 'unlimited' => '' ), NULL, NULL, NULL, 'g_sig_max_images' ) );
			...
			$form->add( new \IPS\Helpers\Form\Number( 'g_sig_max_urls', $signatureLimits[4], FALSE, array( 'unlimited' => '' ), NULL, NULL, NULL, 'g_sig_max_urls' ) );
			$form->add( new \IPS\Helpers\Form\Number( 'g_sig_max_lines', $signatureLimits[5], FALSE, array( 'unlimited' => '' ), NULL, NULL, NULL, 'g_sig_max_lines' ) );
		}
	}
