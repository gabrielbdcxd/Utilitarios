<?php
/**
 * @brief		Bulk mail filter extension: member groups
 *
...
/**
 * @brief	Bulkmail filter: Member group
 */
class _Group
{
	/**
	...
	{
		return ( empty( $post['bmf_members_groups'] ) OR $post['bmf_members_groups'] == 'all' ) ? FALSE : array( 'groups' => implode( ',', $post['bmf_members_groups'] ) );
	}
