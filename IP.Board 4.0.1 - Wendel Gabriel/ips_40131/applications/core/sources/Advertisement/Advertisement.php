...
class _Advertisement extends \IPS\Patterns\ActiveRecord
{
	...
	public static function loadByLocation( $location )
	{
		...
		/* Weed out any we don't see due to our group. This is done after loading the advertisements so that the cache can be properly primed regardless of group. */
