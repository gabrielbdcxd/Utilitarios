...
class _CustomField extends \IPS\CustomField
{
	 ...
	 */
	public static $uploadStorageExtension = 'nexus_PackageFields';
	...
	public function form( &$form )
	{
		...
		$form->add( new \IPS\Helpers\Form\YesNo( 'cf_purchase', $this->purchase, FALSE, array( 'togglesOn' => array( 'cf_required' ) ) ) );
		$form->add( new \IPS\Helpers\Form\YesNo( 'cf_editable', $this->editable, FALSE, array( 'togglesOn' => array( 'cf_required' ) ) ) );
		$form->add( new \IPS\Helpers\Form\YesNo( 'cf_required', $this->required, FALSE, array(), NULL, NULL, NULL, 'cf_required' ) );
