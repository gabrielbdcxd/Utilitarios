...
class _browse extends \IPS\Dispatcher\Controller
{
	...
	protected function _index()
	{
		...
		$highestRated = \IPS\downloads\File::getItemsWithPermission( array( array( 'file_rating > ?', 0 ) ), 'file_rating DESC', 14 );
	...
	protected function _category( $category )
	{
		...
		else
		{
			...
			$table->title = \IPS\Member::loggedIn()->language()->pluralize(  \IPS\Member::loggedIn()->language()->get('download_file_count'), array( $_count['cnt'] ) );
		}
