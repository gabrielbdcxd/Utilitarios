...
{	
	 ...
	 */
	public static $safeFileExtensions = array( 'js', 'css', 'txt', 'xml', 'ico', 'gif', 'jpg', 'jpe', 'jpeg', 'png', 'mp4', '3gp', 'mov', 'ogg', 'ogv', 'mp3', 'mpg', 'mpeg', 'ico', 'flv', 'webm', 'wmv', 'avi', 'm4v', 'svg' );
	...
	public function load()
	{
		...
		$this->url = new \IPS\Http\Url( $this->fullyQualifiedUrl( $this->url ) );
