...
class _DateTime extends \DateTime
{
	 ...
	 *
	 * @note	You can adjust this by changing MONTH_DAY_FORMAT constant which defaults to %B %d
	 * @return	string
	 */
	public function dayAndMonth()
	{
		return \IPS\Member::loggedIn()->language()->convertString( strftime( \IPS\MONTH_DAY_FORMAT, $this->getTimestamp() + $this->getTimezone()->getOffset( $this ) ) );
	}
