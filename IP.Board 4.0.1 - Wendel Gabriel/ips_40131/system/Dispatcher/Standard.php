...
abstract class _Standard extends \IPS\Dispatcher
{
	...
	public function init()
	{
		...
		/* Check domain - www. vs no www. is particularly common */
		if ( mb_strtolower( $_SERVER['REQUEST_METHOD'] ) == 'get' and mb_substr( \IPS\Settings::i()->base_url, 0, 8 ) === 'https://' and \IPS\Request::i()->url()->data['scheme'] !== 'https' )
		{
			\IPS\Output::i()->redirect( new \IPS\Http\Url( preg_replace( '/^http:/', 'https:', \IPS\Request::i()->url() ) ) );
		}
	...
	public function __destruct()
	{
		...
		if ( \IPS\Session\Front::loggedIn() and !\IPS\Settings::i()->task_use_cron )
		{
