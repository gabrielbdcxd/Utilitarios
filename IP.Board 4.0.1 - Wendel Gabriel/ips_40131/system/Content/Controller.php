...
class _Controller extends \IPS\Helpers\CoverPhoto\Controller
{
	...
	protected function checkForNewReplies()
	{
		try
		{
			...
			$newComments = $item->comments( NULL, 0, 'date', 'asc', NULL, NULL, \IPS\DateTime::ts( $lastComment->$commentDateColumn ), array_merge( $where, array( "{$authorColumn} != " . \IPS\Member::loggedIn()->member_id ) ) );
