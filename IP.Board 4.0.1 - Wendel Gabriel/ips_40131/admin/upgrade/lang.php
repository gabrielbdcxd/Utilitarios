...
$lang = array(
	...
	'login_err_no_cookies'			=> "Your browser does not accept cookies which is required in order to log in.",
	...
	'requirements_mysql_version_fail'	=> "You are running MySQL version %s. You need MySQL 5.1.3 or above (5.6 or above recommended). You should contact your hosting provider or system administrator to ask for an upgrade.",
	'requirements_mysql_version_advice'	=> "You are running MySQL version %s. While this version is compatible, we recommend version 5.6 or above.",
	...
	'apps_will_be_disabled'	=> "Some applications are not compatible with the core. You need to be upgrade all applications in the suite, otherwise the following applications will be disabled:",
	...
	'license'				=> "License",
	'license_inactive'		=> 'Your license is currently inactive. You will need to renew before you can upgrade.',
	'lkey'					=> "License Key",
	'lkey_help'				=> "Help",
	...
	'40000_nexus_modules_desc'			=> "Custom code to run when packages are purchased, etc. cannot be converted during the upgrade.",
