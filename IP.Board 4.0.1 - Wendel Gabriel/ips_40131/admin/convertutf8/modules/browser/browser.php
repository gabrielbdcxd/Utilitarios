...
{	
	...
	public function finish()
	{
		...
		\IPSUtf8\Convert::i()->deleteOriginalTables();
	...
	public function welcome()
	{
		...
		if ( \IPSUtf8\Convert::i()->databaseIsUtf8() )
		{
			\IPSUtf8\Output\Browser::i()->error( 'The database tables are UTF-8, collations are correct and there is nothing to convert. You can <strong><a href="../upgrade">proceed with the upgrade</strong>.' );
			exit();
		}
